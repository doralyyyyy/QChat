...
FeatureMenuWidget::FeatureMenuWidget(QWidget *parent) : QWidget(parent) {
    ...
    QAction *wordCloudAction = menu->addAction(QIcon(wordPixmap.scaled(72, 72, Qt::KeepAspectRatio, Qt::SmoothTransformation)), "高频词统计");
    QAction *relationAction = menu->addAction(QIcon(relationPixmap.scaled(72, 72, Qt::KeepAspectRatio, Qt::SmoothTransformation)), "用户关系分析");
    QAction *exportPdfAction = menu->addAction(QIcon(pdfPixmap.scaled(72, 72, Qt::KeepAspectRatio, Qt::SmoothTransformation)), "导出为 PDF");
    QAction *timelineAction = menu->addAction(QIcon(timelinePixmap.scaled(72, 72, Qt::KeepAspectRatio, Qt::SmoothTransformation)), "聊天时间轴");
    QAction *feedbackAction = menu->addAction(QIcon(feedbackPicmap.scaled(72, 72, Qt::KeepAspectRatio, Qt::SmoothTransformation)), "反馈与建议");
