...
MainWindow::MainWindow(Client *client, QWidget *parent)
    ...
    connect(sendFileAction, &QAction::triggered, this, &MainWindow::onSendFileButtonClicked);
    connect(delaySendAction, &QAction::triggered, this, &MainWindow::onDelaySendClicked);
    ...
    connect(menuWidget, &FeatureMenuWidget::generateTimelineRequested, this, &MainWindow::onGenerateTimelineRequested);
...
void MainWindow::onGenerateTimelineRequested() {
    if (messages.isEmpty()) {
